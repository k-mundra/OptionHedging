from modeling.heston_model_sa import sim_heston_paths, heston_greeks, heston_option_price
import numpy as np
...
def dynamic_hedge_vega(hedge_freq=10):
    ...
    for t_idx in hedge_indices:
        ...
        for i in range(num_paths_outer):
            ...
            # primary option
            price1 = heston_option_price(S_t[i], K1, V_t[i], kappa, theta, sigma, rho, lambd, T, r)
            price_plus1 = heston_option_price(S_t[i]+h, K1, V_t[i], kappa, theta, sigma, rho, lambd, T, r)
            price_minus1 = heston_option_price(S_t[i]-h, K1, V_t[i], kappa, theta, sigma, rho, lambd, T, r)
            price_plus_v1 = heston_option_price(S_t[i], K1, V_t[i]+h_vega, kappa, theta, sigma, rho, lambd, T, r)
            price_minus_v1 = heston_option_price(S_t[i], K1, V_t[i]-h_vega, kappa, theta, sigma, rho, lambd, T, r)
            ...
            price2 = heston_option_price(S_t[i], K2, V_t[i], kappa, theta, sigma, rho, lambd, T, r)
            price_plus2 = heston_option_price(S_t[i]+h, K2, V_t[i], kappa, theta, sigma, rho, lambd, T, r)
            price_minus2 = heston_option_price(S_t[i]-h, K2, V_t[i], kappa, theta, sigma, rho, lambd, T, r)
            price_plus_v2 = heston_option_price(S_t[i], K2, V_t[i]+h_vega, kappa, theta, sigma, rho, lambd, T, r)
            price_minus_v2 = heston_option_price(S_t[i], K2, V_t[i]-h_vega, kappa, theta, sigma, rho, lambd, T, r)
...
if __name__ == "__main__":
    pnl = dynamic_hedge_vega(hedge_freq=10)# for semi analytical solution
